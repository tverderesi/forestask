...
export function About() {
  return (
    <section
      className="pt-24 pb-8 snap-center snap-always h-screen w-screen flex flex-col lg:flex-row items-center lg:justify-around"
      id="about"
    >
      <div className="w-full h-2/5 lg:w-2/5 lg:h-4/5 m-auto lg:m-0">
        <JourneyIcon />
      </div>
      <div className="w-full lg:w-2/5 px-6 lg:p-16 flex flex-col items-center justify-center">
        <h1 className="w-full text-2xl lg:text-3xl font-bold text-left mb-4">
          About Florestarefa
        </h1>
        <p className="w-full text-lg lg:text-xl leading-relaxed text-justify lg:text-left">
