...
export default function AccordionDeadline() {
  ...
  return (
    <section className='flex items-center justify-around g-0 justify-self-center'>
      <div
      ...
      >
        <input
          type='date'
          className=' text-center bg-transparent w-4/5 mt-auto mb-auto border-none font-semibold active:border-none active:outline-none'
          onChange={(e: any) => {
            const payload = {
              ...filters,
