  ...
  return (
    ...
    >
      <g
        ...
        style={{ transformOrigin: "252.02px 288.797px 0px" }}
        className="animable"
      >
        <g
          id="freepik--Mountains--inject-2"
          style={{ transformOrigin: "252.015px 213.787px 0px" }}
          className="animable"
        >
          <g
            id="freepik--mountains--inject-2"
          ...
          >
            <path
              ...
              style={{
                ...
                transformOrigin: " 342.865px 213.787px 0px",
              }}
              id="el9ssemyzvlmk"
              className="animable"
            ></path>
            ...
            <path
              ...
              style={{
                ...
                transformOrigin: " 371.135px 139.83px 0px",
              }}
              id="elgt7s22sm19e"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(230, 220, 230)",
                transformOrigin: " 314.245px 118.06px 0px",
              }}
              id="eloxj9ec8qtxf"
              className="animable"
            ></path>
            <g id="el9byq8x4bdcj">
              <path
                ...
                style={{
                  fill: " rgb(255, 255, 255)",
                  opacity: "0.3",
                  transformOrigin: " 335.326px 134.2px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <g id="elus4nf4x1yyq">
              <path
                ...
                style={{
                  fill: " rgb(255, 255, 255)",
                  opacity: "0.3",
                  transformOrigin: " 413.415px 193.384px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " rgb(224, 224, 224)",
                transformOrigin: " 154.83px 222.568px 0px",
              }}
              id="elmy9zwj5gyta"
              className="animable"
            ></path>
            ...
            <path
              ...
              style={{
                fill: " rgb(230, 220, 230)",
                transformOrigin: " 206.445px 141.614px 0px",
              }}
              id="elnl4m0hpug6h"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(230, 220, 230)",
                transformOrigin: " 136.825px 133.831px 0px",
              }}
              id="elp41ya0pguqs"
              className="animable"
            ></path>
            <g id="eldx7xkvbirb9">
              <path
                ...
                style={{
                  fill: " rgb(255, 255, 255)",
                  opacity: "0.3",
                  transformOrigin: " 155.269px 143.565px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <g id="elofp6e4vasrg">
              <path
                ...
                style={{
                  fill: " rgb(255, 255, 255)",
                  opacity: "0.3",
                  transformOrigin: " 233.345px 182.339px 0px",
                }}
                className="animable"
              ></path>
            </g>
        ...
        <g
          id="freepik--floor--inject-2"
          style={{ transformOrigin: "252.02px 320.83px 0px" }}
          className="animable"
        >
          <path
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 252.05px 251.075px 0px",
            }}
            className="animable"
          ></path>
          <g
            id="freepik--floor--inject-2"
            style={{ transformOrigin: "252.02px 337.97px 0px" }}
            className="animable"
          >
            <ellipse
              id="freepik--Grass--inject-2"
              cx="252.02"
              cy="337.97"
              rx="233.1"
              ry="133.97"
              style={{
                fill: " #428c0e",
                transformOrigin: " 252.02px 337.97px 0px",
              }}
              className="animable"
            ></ellipse>
          ...
          <g id="freepik--Way--inject-2">
            <path
              ...
              style={{
                fill: " rgb(255, 255, 255)",
                opacity: "0.8",
                transformOrigin: " 287.157px 338.145px 0px",
              }}
              className="animable"
            ></path>
          </g>
      ...
      <g
        id="freepik--Flag--inject-2"
        style={{ transformOrigin: "325.028px 98.7662px 0px" }}
        className="animable"
      >
        <g
          id="freepik--flag--inject-2"
        ...
        >
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 325.255px 95.4213px 0px",
            }}
            id="elmjpaz83rdz"
            className="animable"
          ></path>
          <path
            ...
            style={{
              fill: " rgb(69, 90, 100)",
              transformOrigin: " 317.165px 98.7662px 0px",
            }}
            id="ele6uqkwcfhgw"
            className="animable"
          ></path>
      ...
      <g
        id="freepik--rocks-2--inject-2"
        style={{ transformOrigin: "407.255px 299.115px 0px" }}
        className="animable"
      >
        <g
          id="freepik--Rocks--inject-2"
          style={{ transformOrigin: "407.255px 299.115px 0px" }}
          className="animable"
        >
          <g
            id="freepik--grass--inject-2"
            style={{ transformOrigin: "432.313px 294.075px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 427.413px 298.63px 0px",
              }}
              id="ela835qqxg75r"
              className="animable"
            ></path>
            ...
            <g id="el7y78gi2ggqc">
              <path
                ...
                style={{
                  fill: " #428c0e",
                  opacity: "0.6",
                  transformOrigin: " 426.703px 298.375px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 432.664px 294.08px 0px",
              }}
              id="elnyah1i1b2i"
              className="animable"
            ></path>
            ...
            <g id="el6pubg0u9kze">
              <path
                ...
                style={{
                  fill: " #428c0e",
                  opacity: "0.6",
                  transformOrigin: " 432.664px 293.715px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 433.9px 302.795px 0px",
              }}
              id="elujq05dc0eb"
              className="animable"
            ></path>
            ...
            <g id="elqi8tbu7uujo">
              <path
                ...
                style={{
                  fill: " #428c0e",
                  opacity: "0.6",
                  transformOrigin: " 433.9px 302.52px 0px",
                }}
                className="animable"
              ></path>
            </g>
          ...
          <g
            id="freepik--rocks--inject-2"
            style={{ transformOrigin: "403.62px 306.485px 0px" }}
            className="animable"
          >
            <g id="freepik--Shadow--inject-2">
              <polygon
                ...
                style={{
                  opacity: " 0.1",
                  transformOrigin: " 408.175px 310.945px 0px",
                }}
                className="animable"
              ></polygon>
            </g>
            <g
              id="freepik--rocks--inject-2"
              style={{ transformOrigin: "402.355px 305.21px 0px" }}
              className="animable"
            >
              <g
                id="freepik--Rock--inject-2"
                style={{ transformOrigin: "395.02px 305.21px 0px" }}
                className="animable"
              >
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 392.56px 298.615px 0px",
                  }}
                  id="el0a64s8hyzjsp"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 400.655px 296.11px 0px",
                  }}
                  id="el149dz255zmy"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 403.6px 308.44px 0px",
                  }}
                  id="elesht9vaewl9"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 409.84px 309.265px 0px",
                  }}
                  id="elrem5rb4lcgs"
                  className="animable"
                ></polygon>
                <g id="elw346tlkib4">
                  <g
                    style={{
                      opacity: " 0.5",
                      transformOrigin: " 404.125px 308.44px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="411.51 297.35 412.34 301.96 408.12 300.63 403.09 303.28 400.84 306.13 399.12 311.71 397.4 319.53 394.86 312.83 398.62 306.34 402.33 302.1 407.81 300.13 411.51 297.35"
                      id="el3kgou7eu4wl"
                      style={{ transformOrigin: "403.6px 308.44px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="406.29 315 413.39 308.92 410.31 303.53 406.29 315"
                      id="eld0hqg5i2icg"
                      style={{ transformOrigin: "409.84px 309.265px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 391.54px 300.475px 0px",
                  }}
                  id="elfh2eub39f38"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 402px 296.2px 0px",
                  }}
                  id="el0793ow8prqtc"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 387.14px 307.165px 0px",
                  }}
                  id="elqmpo3q69o5"
                  className="animable"
                ></polygon>
                <g id="els0ttstgl0b">
                  <g
                    style={{
                      opacity: " 0.25",
                      transformOrigin: " 389.97px 301.95px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="391.63 294.61 388.19 298.66 387.41 300.91 390.86 301.05 398.62 306.34 390.69 302.72 384.46 301.85 387.67 297.26 391.63 294.61"
                      id="elmwgbjmkmz6k"
                      style={{ transformOrigin: "391.54px 300.475px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="403 291.07 402.93 296.69 399.72 300.05 400.66 301.33 404.28 296.96 403 291.07"
                      id="elg6tyvgkc3md"
                      style={{ transformOrigin: "402px 296.2px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="394.86 312.83 390.43 312.05 381.4 309.33 375.66 305.18 377.69 302.1 381.06 301.5 378.34 302.75 377.95 304.9 381.07 307.25 394.35 311.56 398.62 306.34 394.86 312.83"
                      id="elnq7isd9yyj"
                      style={{ transformOrigin: "387.14px 307.165px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 386.755px 304.41px 0px",
                  }}
                  id="elv1h1zentzf9"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 405.065px 298.705px 0px",
                  }}
                  id="elwkwe7z6qnd"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 404.715px 308.735px 0px",
                  }}
                  id="ell0r2ry10d9"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 387.69px 304.05px 0px",
                  }}
                  id="elhtg6f5u2ohl"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 385.27px 311.27px 0px",
                  }}
                  id="elpxlwp48vjj"
                  className="animable"
                ></polygon>
                <g id="el8xchvwfpfyx">
                  <g
                    style={{
                      opacity: " 0.45",
                      transformOrigin: " 395.81px 303.955px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="403 291.07 411.51 297.35 407.81 300.13 402.33 302.1 398.62 306.34 400.66 301.33 404.28 296.96 403 291.07"
                      id="elgfve1jjqlsa"
                      style={{ transformOrigin: "405.065px 298.705px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="408.12 300.63 403.09 303.28 400.84 306.13 399.12 311.71 400.72 316.84 406.29 315 410.31 303.53 408.12 300.63"
                      id="ellm6fi1hqini"
                      style={{ transformOrigin: "404.715px 308.735px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="384.46 301.85 387.51 306.25 390.92 305.93 390.69 302.72 384.46 301.85"
                      id="elubu97l6df5"
                      style={{ transformOrigin: "387.69px 304.05px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="380.11 312.55 382.95 313.21 384.32 311.63 390.43 312.05 381.4 309.33 380.11 312.55"
                      id="elbjmduxng2eg"
                      style={{ transformOrigin: "385.27px 311.27px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 390.505px 315.15px 0px",
                  }}
                  id="elx2ippg1h2tg"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 411.925px 304.775px 0px",
                  }}
                  id="eluitvvuvebaf"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 399.06px 315.62px 0px",
                  }}
                  id="elsnt075xamo"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 394.655px 306.4px 0px",
                  }}
                  id="eletfis6iuq1"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 377.855px 308.865px 0px",
                  }}
                  id="elixx2qpqa43a"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 393.975px 316.02px 0px",
                  }}
                  id="eleg5wtjk2uee"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 386.69px 313.31px 0px",
                  }}
                  id="elxiv25kh7cvc"
                  className="animable"
                ></polygon>
                <g id="el4k9349g07z4">
                  <g
                    style={{
                      opacity: " 0.4",
                      transformOrigin: " 395.02px 310.08px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="412.34 301.96 415.73 306.39 413.39 308.92 410.31 303.53 408.12 300.63 412.34 301.96"
                      id="elxt3i1qoiscb"
                      style={{ transformOrigin: "411.925px 304.775px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="397.4 319.53 400.72 316.84 399.12 311.71 397.4 319.53"
                      id="elx8a2wrqhw7l"
                      style={{ transformOrigin: "399.06px 315.62px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="398.62 306.34 395.56 310.08 390.92 305.93 390.69 302.72 398.62 306.34"
                      id="elu5yez6m542f"
                      style={{ transformOrigin: "394.655px 306.4px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="375.66 305.18 374.31 309.07 380.11 312.55 381.4 309.33 375.66 305.18"
                      id="elaexv5h1nf0b"
                      style={{ transformOrigin: "377.855px 308.865px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="397.4 319.53 390.55 318.25 393.01 312.51 394.86 312.83 397.4 319.53"
                      id="elhleinq97h8r"
                      style={{ transformOrigin: "393.975px 316.02px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="382.95 313.21 388 314.99 390.43 312.05 384.32 311.63 382.95 313.21"
                      id="elrumtscsafka"
                      style={{ transformOrigin: "386.69px 313.31px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
              ...
              <g
                id="freepik--rock--inject-2"
                style={{ transformOrigin: "419px 311.32px 0px" }}
                className="animable"
              >
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 417.65px 307.69px 0px",
                  }}
                  id="elb9e535gbtyn"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 422.105px 306.31px 0px",
                  }}
                  id="elzj6l06j9pon"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 423.73px 313.095px 0px",
                  }}
                  id="elx8jz0528vfn"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 427.16px 313.555px 0px",
                  }}
                  id="elh3dvw5cv4c4"
                  className="animable"
                ></polygon>
                <g id="elpz3kuw6k8b">
                  <g
                    style={{
                      opacity: " 0.5",
                      transformOrigin: " 424.015px 313.095px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="428.08 306.99 428.54 309.53 426.21 308.8 423.44 310.26 422.21 311.83 421.26 314.9 420.31 319.2 418.92 315.51 420.98 311.94 423.03 309.61 426.04 308.52 428.08 306.99"
                      id="elf58ho3kblmn"
                      style={{ transformOrigin: "423.73px 313.095px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="425.21 316.71 429.11 313.36 427.42 310.4 425.21 316.71"
                      id="elmk6bje61tws"
                      style={{ transformOrigin: "427.16px 313.555px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 417.085px 308.71px 0px",
                  }}
                  id="el15tgcxh9xz"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 422.845px 306.36px 0px",
                  }}
                  id="elnt8modtwlbp"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 414.66px 312.395px 0px",
                  }}
                  id="elz30m3251i8m"
                  className="animable"
                ></polygon>
                <g id="el6hjx298t0zn">
                  <g
                    style={{
                      opacity: " 0.25",
                      transformOrigin: " 416.22px 309.525px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="417.13 305.48 415.24 307.71 414.81 308.95 416.71 309.03 420.98 311.94 416.62 309.95 413.19 309.47 414.95 306.94 417.13 305.48"
                      id="elpnmid6or1h"
                      style={{ transformOrigin: "417.085px 308.71px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="423.4 303.54 423.36 306.63 421.59 308.48 422.11 309.18 424.1 306.78 423.4 303.54"
                      id="elcjoaw8c7hi"
                      style={{ transformOrigin: "422.845px 306.36px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="418.92 315.51 416.48 315.09 411.5 313.59 408.34 311.3 409.46 309.61 411.32 309.28 409.82 309.96 409.6 311.15 411.32 312.44 418.63 314.81 420.98 311.94 418.92 315.51"
                      id="el0x2xi3jhpbqh"
                      style={{ transformOrigin: "414.66px 312.395px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 414.45px 310.875px 0px",
                  }}
                  id="elihvam2m6pe"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 424.53px 307.74px 0px",
                  }}
                  id="eloambqjf0i2m"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 424.34px 313.26px 0px",
                  }}
                  id="el7lklm4x21av"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 414.965px 310.68px 0px",
                  }}
                  id="elpc625t6323o"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 413.635px 314.66px 0px",
                  }}
                  id="eltbbzlf7ch9j"
                  className="animable"
                ></polygon>
                <g id="el579by9rh7l3">
                  <g
                    style={{
                      opacity: " 0.45",
                      transformOrigin: " 419.435px 310.63px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="423.4 303.54 428.08 306.99 426.04 308.52 423.03 309.61 420.98 311.94 422.11 309.18 424.1 306.78 423.4 303.54"
                      id="el0gy1x2lhjy1t"
                      style={{ transformOrigin: "424.53px 307.74px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="426.21 308.8 423.44 310.26 422.21 311.83 421.26 314.9 422.14 317.72 425.21 316.71 427.42 310.4 426.21 308.8"
                      id="elpde5gzbm8xk"
                      style={{ transformOrigin: "424.34px 313.26px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="413.19 309.47 414.87 311.89 416.74 311.72 416.62 309.95 413.19 309.47"
                      id="elfxetlwcap4"
                      style={{ transformOrigin: "414.965px 310.68px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="410.79 315.36 412.36 315.73 413.11 314.86 416.48 315.09 411.5 313.59 410.79 315.36"
                      id="elxwdg40asbos"
                      style={{ transformOrigin: "413.635px 314.66px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 416.52px 316.795px 0px",
                  }}
                  id="el6tb6vnwqfxc"
                  className="animable"
                ></polygon>
                ...
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 428.305px 311.08px 0px",
                  }}
                  id="elvrffutgg0ep"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 421.225px 317.05px 0px",
                  }}
                  id="elv2qi21zth8e"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 418.8px 311.975px 0px",
                  }}
                  id="elcjg6h5crzlw"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 409.55px 313.33px 0px",
                  }}
                  id="el7kttvv80e7b"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 418.425px 317.27px 0px",
                  }}
                  id="elxs8aktn1egn"
                  className="animable"
                ></polygon>
                <polygon
                  ...
                  style={{
                    fill: " #428c0e",
                    transformOrigin: " 414.42px 315.78px 0px",
                  }}
                  id="el6i2hyqky989"
                  className="animable"
                ></polygon>
                <g id="el7zl9j6cy4dr">
                  <g
                    style={{
                      opacity: " 0.4",
                      transformOrigin: " 419px 314px 0px",
                    }}
                    className="animable"
                  >
                    <polygon
                      points="428.54 309.53 430.4 311.97 429.11 313.36 427.42 310.4 426.21 308.8 428.54 309.53"
                      id="eldjh81qolzet"
                      style={{ transformOrigin: "428.305px 311.08px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="420.31 319.2 422.14 317.72 421.26 314.9 420.31 319.2"
                      id="elw4lboa5kpq"
                      style={{ transformOrigin: "421.225px 317.05px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="420.98 311.94 419.3 314 416.74 311.72 416.62 309.95 420.98 311.94"
                      id="elu7wfbds49s"
                      style={{ transformOrigin: "418.8px 311.975px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="408.34 311.3 407.6 313.44 410.79 315.36 411.5 313.59 408.34 311.3"
                      id="el6uhiil1kh8r"
                      style={{ transformOrigin: "409.55px 313.33px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="420.31 319.2 416.54 318.5 417.9 315.34 418.92 315.51 420.31 319.2"
                      id="elulrqtrnstm"
                      style={{ transformOrigin: "418.425px 317.27px 0px" }}
                      className="animable"
                    ></polygon>
                    <polygon
                      points="412.36 315.73 415.14 316.7 416.48 315.09 413.11 314.86 412.36 315.73"
                      id="elkp5gfgagph"
                      style={{ transformOrigin: "414.42px 315.78px 0px" }}
                      className="animable"
                    ></polygon>
                  </g>
                </g>
      ...
      <g
        ...
        style={{ transformOrigin: "167.294px 51.9888px 0px" }}
        className="animable"
      >
        <path
          ...
          style={{
            fill: " rgb(230, 220, 230)",
            transformOrigin: " 133.083px 40.0693px 0px",
          }}
          className="animable"
        ></path>
        <path
          ...
          style={{
            fill: " rgb(230, 220, 230)",
            transformOrigin: " 231.336px 69.7391px 0px",
          }}
          className="animable"
        ></path>
      </g>
      <g
        id="freepik--Sun--inject-2"
        style={{ transformOrigin: "417.77px 65.38px 0px" }}
        className="animable"
      >
        <circle
          id="freepik--sun--inject-2"
          ...
          style={{
            ...
            transformOrigin: " 417.77px 65.38px 0px",
          }}
          className="animable"
        ></circle>
      </g>
      <g
        ...
        style={{ transformOrigin: "252.141px 227.188px 0px" }}
        className="animable"
      >
        <g
          id="freepik--Tree--inject-2"
          style={{ transformOrigin: "77.3834px 215.778px 0px" }}
          className="animable"
        >
          <g
            id="freepik--tree--inject-2"
            style={{ transformOrigin: "77.3834px 214.163px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 77.3834px 198.093px 0px",
              }}
              id="ela46v1n9l23a"
              className="animable"
            ></path>
            ...
            <g id="eli6w46gzdqn8">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 76.2124px 212.887px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 77.925px 219.495px 0px",
              }}
              id="elast5ar1di1l"
              className="animable"
            ></path>
          ...
          <g
            id="freepik--Bush--inject-2"
            style={{ transformOrigin: "76.0961px 255.334px 0px" }}
            className="animable"
          >
            <path
              id="freepik--bush--inject-2"
              ...
              style={{
                fill: " rgb(69, 90, 100)",
                transformOrigin: " 70.3341px 254.499px 0px",
              }}
              className="animable"
            ></path>
            <g
              id="freepik--bush--inject-2"
              style={{ transformOrigin: "79.1323px 257.462px 0px" }}
              className="animable"
            >
              <path
                id="freepik--bush--inject-2"
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 79.1323px 257.462px 0px",
                }}
                className="animable"
              ></path>
            </g>
        ...
        <g
          id="freepik--tree--inject-2"
          style={{ transformOrigin: "40.4346px 227.78px 0px" }}
          className="animable"
        >
          <g
            id="freepik--tree--inject-2"
            style={{ transformOrigin: "40.4346px 225.21px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 40.4646px 202.905px 0px",
              }}
              id="el73en0a01mob"
              className="animable"
            ></path>
            ...
            <g id="elneim68ujjjk">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 39.0807px 214.257px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 41.04px 231.341px 0px",
              }}
              id="eln53rkbqjj6"
              className="animable"
            ></path>
          ...
          <g
            id="freepik--bush--inject-2"
            style={{ transformOrigin: "38.9301px 282.967px 0px" }}
            className="animable"
          >
            <path
              id="freepik--bush--inject-2"
              ...
              style={{
                fill: " rgb(69, 90, 100)",
                transformOrigin: " 35.0291px 282.392px 0px",
              }}
              className="animable"
            ></path>
            <g
              id="freepik--bush--inject-2"
              style={{ transformOrigin: "40.9789px 284.437px 0px" }}
              className="animable"
            >
              <path
                id="freepik--bush--inject-2"
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 40.9789px 284.437px 0px",
                }}
                className="animable"
              ></path>
            </g>
        ...
        <g
          id="freepik--tree--inject-2"
          style={{ transformOrigin: "427.438px 214.326px 0px" }}
          className="animable"
        >
          <g
            id="freepik--tree--inject-2"
            style={{ transformOrigin: "427.438px 212.712px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 427.408px 196.641px 0px",
              }}
              id="el7u7zfgzjovp"
              className="animable"
            ></path>
            ...
            <g id="eltaft8bcnmd">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 427.519px 209.99px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 426.86px 218.005px 0px",
              }}
              id="elvu3gfmwm5y"
              className="animable"
            ></path>
          ...
          <g
            id="freepik--bush--inject-2"
            style={{ transformOrigin: "428.709px 253.84px 0px" }}
            className="animable"
          >
            <path
              id="freepik--bush--inject-2"
              ...
              style={{
                fill: " rgb(69, 90, 100)",
                transformOrigin: " 434.469px 252.982px 0px",
              }}
              className="animable"
            ></path>
            <g
              id="freepik--bush--inject-2"
              style={{ transformOrigin: "425.659px 256.014px 0px" }}
              className="animable"
            >
              <path
                id="freepik--bush--inject-2"
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 425.659px 256.014px 0px",
                }}
                className="animable"
              ></path>
            </g>
        ...
        <g
          id="freepik--tree--inject-2"
          style={{ transformOrigin: "463.826px 227.723px 0px" }}
          className="animable"
        >
          <g
            id="freepik--tree--inject-2"
            style={{ transformOrigin: "463.826px 225.17px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 463.771px 202.85px 0px",
              }}
              id="elp3ls71ytlz"
              className="animable"
            ></path>
            ...
            <g id="elhdttxv99och">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 465.185px 214.297px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 463.2px 231.356px 0px",
              }}
              id="elcamscviz4wf"
              className="animable"
            ></path>
          ...
          <g
            id="freepik--bush--inject-2"
            style={{ transformOrigin: "465.305px 282.964px 0px" }}
            className="animable"
          >
            <path
              id="freepik--bush--inject-2"
              ...
              style={{
                fill: " rgb(69, 90, 100)",
                transformOrigin: " 469.212px 282.392px 0px",
              }}
              className="animable"
            ></path>
            <g
              id="freepik--bush--inject-2"
              style={{ transformOrigin: "463.238px 284.444px 0px" }}
              className="animable"
            >
              <path
                id="freepik--bush--inject-2"
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 463.238px 284.444px 0px",
                }}
                className="animable"
              ></path>
            </g>
      ...
      <g
        id="freepik--Locators--inject-2"
        style={{ transformOrigin: "318.013px 127.352px 0px" }}
        className="animable"
      >
        <g
          id="freepik--Lines--inject-2"
          style={{ transformOrigin: "319.223px 131.387px 0px" }}
          className="animable"
        >
          <path
            ...
            style={{
              fill: " rgb(230, 220, 230)",
              transformOrigin: " 354.5px 130.837px 0px",
            }}
            id="ellzakvoc9idc"
            className="animable"
          ></path>
          <path
            ...
            style={{
              fill: " rgb(230, 220, 230)",
              transformOrigin: " 316.32px 157.788px 0px",
            }}
            id="elibndd5p5em"
            className="animable"
          ></path>
          <path
            ...
            style={{
              fill: " rgb(230, 220, 230)",
              transformOrigin: " 277.835px 184.272px 0px",
            }}
            id="els6brr34jdn"
            className="animable"
          ></path>
          <path
            ...
            style={{
              fill: " rgb(224, 224, 224)",
              transformOrigin: " 321.696px 78.4475px 0px",
            }}
            id="el2s7ri6jwe6w"
            className="animable"
          ></path>
          <path
            ...
            style={{
              fill: " rgb(224, 224, 224)",
              transformOrigin: " 342.547px 95.0016px 0px",
            }}
            id="elozxs3oovsj"
            className="animable"
          ></path>
          <path
            ...
            style={{
              fill: " rgb(224, 224, 224)",
              transformOrigin: " 360.984px 113.818px 0px",
            }}
            id="elz1spueoc2m9"
            className="animable"
          ></path>
        ...
        <path
          ...
          style={{
            fill: " #428c0e",
            transformOrigin: " 316.988px 63.1207px 0px",
          }}
          className="animable"
        ></path>
        <path
          ...
          style={{
            fill: " rgb(55, 71, 79)",
            transformOrigin: " 356.145px 118.087px 0px",
          }}
          className="animable"
        ></path>
        <path
          ...
          style={{
            fill: " rgb(55, 71, 79)",
            transformOrigin: " 314.29px 147.232px 0px",
          }}
          className="animable"
        ></path>
        <path
          ...
          style={{
            fill: " rgb(55, 71, 79)",
            transformOrigin: " 277.22px 173.386px 0px",
          }}
          className="animable"
        ></path>
        <path
          ...
          style={{
            ...
            transformOrigin: " 332.255px 199.99px 0px",
          }}
          className="animable"
        ></path>
      </g>
      <g
        id="freepik--rocks-1--inject-2"
        style={{ transformOrigin: "145.65px 393.585px 0px" }}
        className="animable"
      >
        <g id="freepik--shadow--inject-2">
          <path
            ...
            style={{
              opacity: " 0.15",
              transformOrigin: " 145.65px 438.511px 0px",
            }}
            className="animable"
          ></path>
        </g>
        <g
          id="freepik--Boulder--inject-2"
          style={{ transformOrigin: "146.68px 390.86px 0px" }}
          className="animable"
        >
          <g
            id="freepik--grass--inject-2"
            style={{ transformOrigin: "41.365px 371.465px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 47.2673px 374.21px 0px",
              }}
              id="elyn81qfppnxc"
              className="animable"
            ></path>
            ...
            <g id="el4g09hjv0w5j">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 47.5973px 373.895px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 41.375px 371.465px 0px",
              }}
              id="elw4s4cuptwgl"
              className="animable"
            ></path>
            ...
            <g id="el5hz5kkijatg">
              <path
                ...
                style={{
                  opacity: " 0.1",
                  transformOrigin: " 41.365px 371.035px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 41.68px 378.745px 0px",
              }}
              id="elr87op7b8dne"
              className="animable"
            ></path>
            <g id="elo5sfaktn9la">
              <path
                ...
                style={{
                  opacity: " 0.1",
                  transformOrigin: " 41.62px 378.415px 0px",
                }}
                className="animable"
              ></path>
            </g>
          ...
          <g
            id="freepik--grass--inject-2"
            style={{ transformOrigin: "246.07px 413.275px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 241.308px 415.5px 0px",
              }}
              id="elg7ipg2ozs2v"
              className="animable"
            ></path>
            ...
            <g id="elatl9je9m1i5">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 241.038px 415.245px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 246.07px 413.275px 0px",
              }}
              id="el1mzyv8y4g3i"
              className="animable"
            ></path>
            ...
            <g id="el4zan2i9sq2j">
              <path
                ...
                style={{
                  opacity: " 0.1",
                  transformOrigin: " 246.07px 412.955px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 245.825px 419.155px 0px",
              }}
              id="ellu2fctz105"
              className="animable"
            ></path>
            <g id="elednzydzgg8w">
              <path
                ...
                style={{
                  opacity: " 0.1",
                  transformOrigin: " 245.855px 418.91px 0px",
                }}
                className="animable"
              ></path>
            </g>
          ...
          <path
            ...
            style={{
              fill: " rgb(69, 90, 100)",
              transformOrigin: " 146.165px 431.275px 0px",
            }}
            id="ellu42z2jlq4"
            className="animable"
          ></path>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 139.665px 459.83px 0px",
            }}
            id="el5rsr7yoiye6"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 112.445px 439.425px 0px",
            }}
            id="elytlorggyxuq"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 216.425px 449.18px 0px",
            }}
            id="elf4um6qdcofw"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 175.06px 466.755px 0px",
            }}
            id="elw93ccywqbv9"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 250.65px 454.885px 0px",
            }}
            id="el610mthlhqop"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 67.995px 421.75px 0px",
            }}
            id="elk43i4kwivz"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 45.79px 414.64px 0px",
            }}
            id="elduzue9lw268"
            className="animable"
          ></polygon>
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 151.875px 418.465px 0px",
            }}
            id="elcydkxvkp1uw"
            className="animable"
          ></path>
          ...
          <g id="elhc1lm14yl8o">
            <polygon
              ...
              style={{
                opacity: " 0.1",
                transformOrigin: " 70.93px 407.85px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elubcyy0gfew">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 50.015px 394.715px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elq2tji3bujj">
            <polygon
              ...
              style={{
                opacity: " 0.1",
                transformOrigin: " 41.36px 391.415px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elpkkfb7kxv">
            <polygon
              ...
              style={{
                opacity: " 0.1",
                transformOrigin: " 115.74px 436.745px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elzk08z99hire">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 139.965px 450.46px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elsst77tgs1sa">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 216.055px 457.27px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 152.005px 417.15px 0px",
            }}
            id="el5y144z3btp"
            className="animable"
          ></path>
          ...
          <polygon
            ...
            style={{
              fill: " rgb(69, 90, 100)",
              transformOrigin: " 186.855px 404.245px 0px",
            }}
            id="els6y3c01oc7f"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 203.14px 369.61px 0px",
            }}
            id="elt24p4028c6j"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 224.19px 423.37px 0px",
            }}
            id="el8q4qmmb0i1t"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 214.045px 417.2px 0px",
            }}
            id="el5bfu90w24n9"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 195.695px 430.815px 0px",
            }}
            id="elo4gq7hvyh4q"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 169.03px 436.845px 0px",
            }}
            id="elk0vop79c0e"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 198.59px 413.955px 0px",
            }}
            id="el56thr85exea"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 136.32px 422.685px 0px",
            }}
            id="elhnzh6ks2t9q"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 159.72px 422.11px 0px",
            }}
            id="elzlobrop31qf"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 159.72px 434.48px 0px",
            }}
            id="elqn9hxxqoom"
            className="animable"
          ></polygon>
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 168.685px 387.805px 0px",
            }}
            id="elaqrdan7wo5m"
            className="animable"
          ></path>
          <g id="eld3ng40fu0m">
            <path
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 168.7px 387.845px 0px",
              }}
              className="animable"
            ></path>
          </g>
          <g id="eluqdjfnmqhyk">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 204.14px 365.195px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 168.945px 387.845px 0px",
            }}
            id="elorer6gqep2"
            className="animable"
          ></path>
          ...
          <g id="el4hvyyd6hoso">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 202.365px 404.425px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elywvwski5o5r">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 136.305px 415.6px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="eldytsz0at265">
            <path
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 96.49px 392.87px 0px",
              }}
              className="animable"
            ></path>
          </g>
          <polygon
            ...
            style={{
              fill: " rgb(69, 90, 100)",
              transformOrigin: " 127.345px 364.325px 0px",
            }}
            id="el4h9rfstpzdb"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 127.205px 375.23px 0px",
            }}
            id="el41a1vh5orvz"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 83.615px 378.505px 0px",
            }}
            id="eliwprbrbsgnl"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 64.73px 365.37px 0px",
            }}
            id="eluxi40wcgahs"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 104.525px 377.58px 0px",
            }}
            id="elusi19nw69dl"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 178.015px 341.14px 0px",
            }}
            id="elx3y8k36342i"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 165.615px 361.09px 0px",
            }}
            id="el4oxa04q8yxs"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(55, 71, 79)",
              transformOrigin: " 186.635px 356.875px 0px",
            }}
            id="elgkgf8fdzdv"
            className="animable"
          ></polygon>
          <polygon
            ...
            style={{
              fill: " rgb(38, 50, 56)",
              transformOrigin: " 189.295px 367.685px 0px",
            }}
            id="elze2uw4v81v"
            className="animable"
          ></polygon>
          <g
            id="freepik--grass--inject-2"
            style={{ transformOrigin: "129.499px 386.32px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 125.384px 389.445px 0px",
              }}
              id="elmwep7f4hwo"
              className="animable"
            ></path>
            ...
            <g id="el1pmlq9uw45g">
              <path
                ...
                style={{
                  opacity: " 0.15",
                  transformOrigin: " 124.834px 389.415px 0px",
                }}
                className="animable"
              ></path>
            </g>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 129.765px 386.305px 0px",
              }}
              id="el01nsv3c02fea"
              className="animable"
            ></path>
            ...
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 130.265px 392.895px 0px",
              }}
              id="el2y7jjtccpju"
              className="animable"
            ></path>
            <g id="el99cy1jechrf">
              <path
                ...
                style={{
                  opacity: " 0.1",
                  transformOrigin: " 130.245px 392.895px 0px",
                }}
                className="animable"
              ></path>
            </g>
          ...
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 123.085px 336.56px 0px",
            }}
            id="elnms5dzvdcz"
            className="animable"
          ></path>
          ...
          <path
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 123.085px 335.09px 0px",
            }}
            id="elci513yv6ml7"
            className="animable"
          ></path>
          ...
          <g id="eld4g2x42kuxo">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 181px 328.945px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elad2re3awkib">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 146.985px 352.45px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="ellqj4xz5ledl">
            <polygon
              ...
              style={{
                opacity: " 0.1",
                transformOrigin: " 118.11px 358.845px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <g id="elqjqfwoqnx88">
            <polygon
              ...
              style={{
                opacity: " 0.3",
                transformOrigin: " 66.35px 345.125px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <polygon
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 185.875px 350.84px 0px",
            }}
            id="ellw1lxvqjr3j"
            className="animable"
          ></polygon>
          <g id="el5elik0tbksr">
            <polygon
              ...
              style={{
                opacity: " 0.2",
                transformOrigin: " 185.875px 352.695px 0px",
              }}
              className="animable"
            ></polygon>
          </g>
          <polygon
            ...
            style={{
              fill: " #428c0e",
              transformOrigin: " 185.225px 350.84px 0px",
            }}
            id="elg3p300re63o"
            className="animable"
          ></polygon>
      ...
      <g
        ...
        style={{ transformOrigin: "116.99px 211.211px 0px" }}
        className="animable"
      >
        <g id="freepik--shadow--inject-2">
          <path
            ...
            style={{
              opacity: " 0.15",
              transformOrigin: " 121.498px 333.487px 0px",
            }}
            className="animable"
          ></path>
        </g>
        <g
          id="freepik--character--inject-2"
          style={{ transformOrigin: "116.99px 209.444px 0px" }}
          className="animable"
        >
          <g
            id="freepik--Bottom--inject-2"
            style={{ transformOrigin: "121.434px 257.77px 0px" }}
            className="animable"
          >
            <path
              ...
              id="elgmcvr3pfa2a"
              style={{ transformOrigin: "149.018px 318.363px 0px" }}
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(69, 90, 100)",
                transformOrigin: " 114.966px 245.955px 0px",
              }}
              id="elvxht15vy2t9"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 118.031px 202.042px 0px",
              }}
              id="el03jrjq2wrmy5"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 139.061px 256.925px 0px",
              }}
              id="ela9e7uymupjc"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 96.21px 199.145px 0px",
              }}
              id="el39yfefu8fpr"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 100.704px 260.175px 0px",
              }}
              id="elbp0r37t1g3s"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 104.703px 200.51px 0px",
              }}
              id="elyajfieo5npq"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 113.285px 231.285px 0px",
              }}
              id="eljmsc03z5tod"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 152.5px 338.538px 0px",
              }}
              id="elu5vg7tia25n"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 151.886px 328.943px 0px",
              }}
              id="elp2bedx110ck"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 155.212px 322.633px 0px",
              }}
              id="el0yyebbhtomke"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 90.1637px 316.1px 0px",
              }}
              id="el2cec33571se"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(55, 71, 79)",
                transformOrigin: " 84.7621px 317.502px 0px",
              }}
              id="eltsyfnmp8qs"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 90.54px 327.225px 0px",
              }}
              id="elgquzeh00lpi"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 77.8028px 324.302px 0px",
              }}
              id="el5gt9ooimh1f"
              className="animable"
            ></path>
            ...
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 84.1272px 323.883px 0px",
              }}
              id="elf3taqytnkue"
              className="animable"
            ></path>
          ...
          <g
            ...
            style={{ transformOrigin: "116.99px 139.492px 0px" }}
            className="animable"
          >
            <path
              ...
              style={{
                fill: " rgb(255, 189, 167)",
                transformOrigin: " 89.527px 146.187px 0px",
              }}
              id="el97yg1bhfxef"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(255, 189, 167)",
                transformOrigin: " 155.299px 110.509px 0px",
              }}
              id="el4ar8hyw7npl"
              className="animable"
            ></path>
            <path
              ...
              style={{
                ...
                transformOrigin: " 146.301px 94.0589px 0px",
              }}
              id="elubt7phgxthp"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 123.047px 95.2841px 0px",
              }}
              id="el5qtlhqfsl1c"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(240, 153, 122)",
                transformOrigin: " 139.099px 100.355px 0px",
              }}
              id="elo3eymuh1cqf"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(255, 189, 167)",
                transformOrigin: " 122.153px 100.222px 0px",
              }}
              id="elvuahso6gco"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(255, 189, 167)",
                transformOrigin: " 118.997px 121.8px 0px",
              }}
              id="elr0d6wzo7mqe"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(240, 153, 122)",
                transformOrigin: " 131.86px 116.332px 0px",
              }}
              id="el8b8hk9rfiev"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 118.043px 98.3105px 0px",
              }}
              id="elmmij5s9r6x"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 90.3142px 100.708px 0px",
              }}
              id="ellgswexmooya"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(38, 50, 56)",
                transformOrigin: " 120.495px 160.802px 0px",
              }}
              id="el5za7321z3n7"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 103.655px 125.575px 0px",
              }}
              id="elr9dsjnxkw5k"
              className="animable"
            ></path>
            ...
            <path
              ...
              style={{
                fill: " #428c0e",
                transformOrigin: " 128px 130.465px 0px",
              }}
              id="elhktr56ctc56"
              className="animable"
            ></path>
            ...
            <g
              id="freepik--Backpack--inject-2"
              style={{ transformOrigin: "110.004px 164.036px 0px" }}
              className="animable"
            >
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 107.854px 164.044px 0px",
                }}
                id="elpurve8ur45"
                className="animable"
              ></path>
              ...
              <g id="el6xtl6olo9n4">
                <path
                  ...
                  style={{
                    opacity: " 0.1",
                    transformOrigin: " 125.752px 169.867px 0px",
                  }}
                  className="animable"
                ></path>
              </g>
              <g id="elfwhltg6hicq">
                <path
                  ...
                  style={{
                    opacity: " 0.4",
                    transformOrigin: " 109.19px 137.597px 0px",
                  }}
                  className="animable"
                ></path>
              </g>
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 99.3768px 182.034px 0px",
                }}
                id="el1z8vdu41w2u"
                className="animable"
              ></path>
              ...
              <g id="elnvq40447tne">
                <path
                  ...
                  style={{
                    opacity: " 0.4",
                    transformOrigin: " 99.365px 175.12px 0px",
                  }}
                  className="animable"
                ></path>
              </g>
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 98.3314px 182.741px 0px",
                }}
                id="eldvcfwpatcx"
                className="animable"
              ></path>
              ...
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 99.0602px 177.39px 0px",
                }}
                id="eli0mcbu5cc3m"
                className="animable"
              ></path>
              ...
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 97.5106px 178.526px 0px",
                }}
                id="elmxz989crv08"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(55, 71, 79)",
                  transformOrigin: " 95.675px 182.038px 0px",
                }}
                id="elp4915jc0h3"
                className="animable"
              ></path>
              <g id="el7q7j82bxyj7">
                <path
                  ...
                  style={{
                    opacity: " 0.15",
                    transformOrigin: " 102.285px 162.42px 0px",
                  }}
                  className="animable"
                ></path>
              </g>
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 107.517px 147.588px 0px",
                }}
                id="elg0kdbdup9c5"
                className="animable"
              ></path>
              ...
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 102.366px 151.185px 0px",
                }}
                id="elkscdwsacbz"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(69, 90, 100)",
                  transformOrigin: " 107.954px 167.192px 0px",
                }}
                id="el6x3ur9hdkoq"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(55, 71, 79)",
                  transformOrigin: " 108.87px 155.767px 0px",
                }}
                id="eluyffseb41v"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(224, 224, 224)",
                  transformOrigin: " 107.273px 173.874px 0px",
                }}
                id="elb96b5r7u03j"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(69, 90, 100)",
                  transformOrigin: " 90.99px 157.839px 0px",
                }}
                id="elgst8a3grxf5"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(55, 71, 79)",
                  transformOrigin: " 92.0096px 146.569px 0px",
                }}
                id="elp9rl62vlvl"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " rgb(224, 224, 224)",
                  transformOrigin: " 90.2847px 164.509px 0px",
                }}
                id="elrywxrg603j"
                className="animable"
              ></path>
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 129.067px 186.014px 0px",
                }}
                id="elvs5dd9de2u"
                className="animable"
              ></path>
              ...
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 131.248px 187.704px 0px",
                }}
                id="el6x6w030ln9a"
                className="animable"
              ></path>
              <g id="elj32biwnmqa">
                <path
                  ...
                  style={{
                    opacity: " 0.4",
                    transformOrigin: " 128.675px 178.195px 0px",
                  }}
                  className="animable"
                ></path>
              </g>
              ...
              <path
                ...
                style={{
                  fill: " #428c0e",
                  transformOrigin: " 128.954px 180.417px 0px",
                }}
                id="elvwkzegw143f"
                className="animable"
              ></path>
              ...
              <path
                ...
                style={{
                  fill: " rgb(55, 71, 79)",
                  transformOrigin: " 132.476px 184.192px 0px",
                }}
                id="elhvym14ce1q"
                className="animable"
              ></path>
            ...
            <path
              ...
              style={{
                fill: " rgb(255, 189, 167)",
                transformOrigin: " 157.146px 136.174px 0px",
              }}
              id="eljx26shiv32"
              className="animable"
            ></path>
            <path
              ...
              style={{
                fill: " rgb(240, 153, 122)",
                transformOrigin: " 168.58px 125.822px 0px",
              }}
              id="el9k0hmo9m64l"
              className="animable"
            ></path>
