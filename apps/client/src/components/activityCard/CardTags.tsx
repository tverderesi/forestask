...
import { MdInfoOutline, MdOutlineLightbulb, MdCalendarToday, MdSentimentVerySatisfied } from "react-icons/md";
...
function CardTags({ subject, type, deadline, xp }: { subject: string; type: string; deadline: Date; xp: number }) {
